...
class MultiRobotCommonPID(Node):
    def __init__(self):
        ...
        self.declare_parameter('wheel_diameter', 0.10)    
        ...
        self.declare_parameter('deriv_alpha', 0.6)         
        self.declare_parameter('yaw_filter_alpha', 0.7)   
        self.declare_parameter('integral_limit', 1.0)

        self.declare_parameter('max_linear', 0.6)         
        self.declare_parameter('max_angular', 1.0)         
        self.declare_parameter('pos_tol', 0.06)            
        self.declare_parameter('ang_tol', 0.03)            
        self.declare_parameter('min_ang_cmd', 0.02)        

        self.declare_parameter('debug_topic', False)       
